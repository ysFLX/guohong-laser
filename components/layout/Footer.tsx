...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden border-t border-amber-200/25 bg-[#142862] text-amber-100">
      ...
      <div className="relative mx-auto max-w-screen-2xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-8 py-12 lg:grid-cols-[1.25fr_1fr]">
          <section className="rounded-3xl border border-amber-200/25 bg-[#142862]/80 p-6 shadow-[0_22px_60px_rgba(8,18,50,0.45)] sm:p-8">
            ...
            <div className="mt-6 flex flex-wrap gap-3">
              ...
              <Link
                href="/contact"
                className="inline-flex items-center justify-center rounded-full border border-amber-200/35 px-5 py-2.5 text-sm font-semibold text-amber-100 transition hover:bg-[#223f86]"
              >
                İletişime Geç
              </Link>
              <a
            ...
            <div className="mt-7 rounded-2xl border border-amber-200/25 bg-[#1b3370] p-4">
                ...
                <div
                  className={`rounded-full border px-3 py-1 text-xs font-semibold ${
                    providerActive
                      ...
                      : 'border-amber-200/30 bg-[#223f86] text-amber-100/90'
                  }`}
                >
                  {providerActive ? 'Odeme Aktif' : 'Aktivasyon Beklemede'}
                </div>
              </div>
              <div className="mt-4 flex items-center gap-3 rounded-xl border border-amber-200/25 bg-[#1d356f] px-3 py-2">
                <Image
              ...
              <div className="mt-3 flex flex-wrap gap-2 text-[11px] font-semibold uppercase tracking-[0.18em] text-amber-100/85">
                <span className="rounded-full border border-amber-200/35 bg-[#223f86] px-3 py-1">Visa</span>
                <span className="rounded-full border border-amber-200/35 bg-[#223f86] px-3 py-1">Mastercard</span>
                <span className="rounded-full border border-amber-200/35 bg-[#223f86] px-3 py-1">Troy</span>
                <span className="rounded-full border border-amber-200/35 bg-[#223f86] px-3 py-1">3D Secure</span>
              </div>
            </div>
          </section>

          <section className="grid gap-6 sm:grid-cols-2">
            <div className="rounded-2xl border border-amber-200/25 bg-[#1b3370] p-6">
            ...
            <div className="rounded-2xl border border-amber-200/25 bg-[#1b3370] p-6 sm:col-span-2">
            ...
            <div className="rounded-2xl border border-amber-200/25 bg-[#1b3370] p-6 sm:col-span-2">
              ...
              <div className="mt-4 grid gap-3 text-sm text-amber-100/80 sm:grid-cols-2">
                <div className="rounded-xl border border-amber-200/20 bg-[#223f86] px-4 py-3">Telefon: +90 536 831 67 87</div>
                <div className="rounded-xl border border-amber-200/20 bg-[#223f86] px-4 py-3">E-posta: guohonglazerinfo@gmail.com</div>
                <div className="rounded-xl border border-amber-200/20 bg-[#223f86] px-4 py-3">Adres: Aksaray Çevreyolu Caddesi Akasya Sanayi Sitesi No: 18T Konya / Karatay 42210</div>
                <div className="rounded-xl border border-amber-200/20 bg-[#223f86] px-4 py-3">Pazartesi - Cuma 09:00 - 17:00</div>
              </div>
            </div>
          </section>
        </div>
