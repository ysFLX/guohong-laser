  ...
  return (
    <footer className="relative overflow-hidden bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-white">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute -top-24 right-10 h-56 w-56 rounded-full bg-emerald-200/70 blur-3xl dark:bg-emerald-500/20" />
        <div className="absolute -bottom-24 left-10 h-64 w-64 rounded-full bg-sky-200/60 blur-3xl dark:bg-emerald-500/10" />
      ...
      <div className="relative max-w-screen-2xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="border-t border-emerald-300/50 dark:border-emerald-500/20" />
        ...
        <div className="grid gap-8 py-12 lg:grid-cols-[1.2fr_1fr]">
          <div className="space-y-6">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/quote" className="inline-flex items-center justify-center rounded-full bg-emerald-600 px-4 py-2 text-sm font-semibold text-white hover:bg-emerald-700">
                Teklif Al
              </Link>
              ...
              <a href="https://wa.me/905368316787" className="inline-flex items-center justify-center rounded-full border border-emerald-200 px-4 py-2 text-sm font-semibold text-emerald-700 hover:bg-emerald-50 dark:border-emerald-400/30 dark:text-emerald-300 dark:hover:bg-emerald-400/10">
                WhatsApp Hatti
              </a>
            </div>
          ...
          <div className="grid gap-6 sm:grid-cols-2">
            <div className="rounded-2xl border border-slate-200/70 bg-white/70 p-5 shadow-sm backdrop-blur dark:border-slate-800/60 dark:bg-slate-900/60">
              ...
              <div className="mt-4 space-y-2 text-sm">
                <Link href="/about" className="block text-slate-700 hover:text-emerald-600 dark:text-slate-200">Hakkimizda</Link>
                <Link href="/products" className="block text-slate-700 hover:text-emerald-600 dark:text-slate-200">Makineler</Link>
                <Link href="/spare-parts" className="block text-slate-700 hover:text-emerald-600 dark:text-slate-200">Yedek Parcalar</Link>
                <Link href="/gallery" className="block text-slate-700 hover:text-emerald-600 dark:text-slate-200">Galeri</Link>
                <Link href="/contact" className="block text-slate-700 hover:text-emerald-600 dark:text-slate-200">Iletisim</Link>
              </div>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200/70 bg-white/70 p-5 shadow-sm backdrop-blur dark:border-slate-800/60 dark:bg-slate-900/60">
              ...
              <div className="mt-4 flex items-center gap-3 text-slate-400">
                <a href="https://www.facebook.com/profile.php?id=61584746766233&locale=tr_TR" className="hover:text-emerald-600">
                ...
                <a href="https://www.instagram.com/gu0honglaser/" className="hover:text-emerald-600">
                ...
                <a href="https://wa.me/905368316787" className="hover:text-emerald-600">
        ...
        <div className="border-t border-slate-200/70 dark:border-slate-800/60 py-5">
          <div className="flex flex-col gap-3 text-xs text-slate-500 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex flex-wrap gap-3">
              <Link href="/privacy" className="hover:text-emerald-600">Gizlilik</Link>
              <Link href="/terms" className="hover:text-emerald-600">Kullanim</Link>
              <Link href="/contact" className="hover:text-emerald-600">Destek</Link>
            </div>
          </div>
        </div>
      </div>
