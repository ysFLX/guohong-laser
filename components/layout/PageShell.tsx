  ...
  return (
    <div className="relative z-0 overflow-x-hidden">
      <div className="pointer-events-none absolute inset-0 -z-10">
        ...
        <div className="absolute -left-24 top-24 h-72 w-72 rounded-full bg-indigo-400/20 blur-[160px] dark:bg-indigo-400/20" />
        <div className="absolute bottom-0 right-16 h-80 w-80 rounded-full bg-indigo-400/15 blur-[180px] dark:bg-indigo-400/12" />
