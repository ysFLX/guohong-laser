  ...
  return (
    <>
      ...
      <button
        ...
        className={`group fixed bottom-[calc(env(safe-area-inset-bottom)+14px)] left-3 z-[120] grid h-12 w-12 place-items-center rounded-full border border-amber-200/45 bg-[var(--surface)] text-amber-500 shadow-[0_18px_50px_rgba(20,40,98,0.32)] backdrop-blur transition-all duration-300 dark:text-amber-100 sm:bottom-6 sm:left-6 ${
