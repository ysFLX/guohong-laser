    ...
    <div className="relative">
      ...
      >
          ...
          <div
            ...
            {failedSources[item.src] ? (
              <div className="relative h-full w-full">
                ...
                <div className="absolute left-5 top-5 rounded-full border border-white/15 bg-slate-950/60 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-white/80 backdrop-blur">
                ...
                <div className="absolute inset-x-0 bottom-0 p-5 text-white">
                  <div className="max-w-[min(80vw,520px)] rounded-2xl border border-white/10 bg-slate-950/55 px-4 py-3 backdrop-blur">
                    <div className="text-lg font-semibold sm:text-2xl">{item.title ?? `Video ${i + 1}`}</div>
        ...
        <div className="pointer-events-none absolute left-5 right-5 top-5 z-20 flex items-start justify-between gap-4">
          <div>
            <div className="inline-flex rounded-full border border-white/10 bg-slate-950/60 px-3 py-1 text-[11px] font-semibold uppercase tracking-[0.24em] text-white/75 backdrop-blur">
