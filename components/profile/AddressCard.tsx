      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-teal-600 to-indigo-600 text-white flex items-center justify-center font-medium">{(address.label || 'A').slice(0,1)}</div>
            <div>
