        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 px-4 pb-20 pt-20 sm:px-6 lg:grid-cols-[1.1fr_0.9fr] lg:px-8 lg:pb-28 lg:pt-28">
          <div>
            ...
            <h1 className="mt-6 text-4xl font-semibold leading-tight sm:text-5xl lg:text-6xl">
              Lazer kesimde
              <span className="block text-emerald-200">yeni bir kalite standardý</span>
            </h1>
              ...
              {[
                {
                  ...
                  description:
                    "Kesim kalitesinde milimetrik deðil, mikron seviyesinde netlik.",
                },
                {
                  title: "Tasarým + üretim gücü",
                  description:
                    "Mühendislik yaklaþýmýyla her hat için optimize edilmiþ çözüm.",
                },
                {
                  title: "Sürekli destek",
                  description:
                    "Kurulum sonrasý eðitim, bakým ve hýzlý yedek parça eriþimi.",
                },
              ].map((item) => (
                <div
                  key={item.title}
