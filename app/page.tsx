...
export default function Home() {
  return (
    <div className={`${manrope.className} space-y-10`}>
      <Reveal as="section" className="grid items-center gap-8 lg:grid-cols-[1.05fr_0.95fr]">
        <div className="space-y-6">
          ...
          <div className="flex flex-wrap gap-3 text-xs font-semibold uppercase tracking-[0.18em] text-slate-500 dark:text-white/70">
            <span className="float-soft rounded-full border border-slate-200/70 bg-white/70 px-4 py-2 dark:border-white/15 dark:bg-white/5">
              Yerinde kurulum
            </span>
            <span className="float-soft rounded-full border border-slate-200/70 bg-white/70 px-4 py-2 dark:border-white/15 dark:bg-white/5">
              Hizli servis
      ...
      <Reveal
        as="section"
        delay={120}
        className="rounded-3xl border border-slate-200/70 bg-white/80 px-6 py-5 text-slate-900 shadow-sm dark:border-white/10 dark:bg-white/5 dark:text-white"
      >
        <div className="flex flex-wrap items-center justify-between gap-4">
          {stats.map((stat, index) => (
            <Reveal key={stat.name} as="div" delay={index * 90} className="flex items-center gap-4">
              <div>
      ...
      <Reveal
        ...
        delay={220}
        id="video"
        className="rounded-3xl border border-slate-200/70 bg-white/80 p-6 shadow-xl dark:border-white/10 dark:bg-white/5"
      >
      ...
      <Reveal as="section" id="hizmetler" className="space-y-5">
      ...
      <Reveal as="section" className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        ...
        <Reveal as="div" delay={180} className="rounded-3xl border border-slate-200/70 bg-white/80 p-6 dark:border-white/10 dark:bg-white/5">
          <p className="text-xs uppercase tracking-[0.3em] text-emerald-600 dark:text-emerald-200">
            Sahadan notlar
          </p>
        ...
        <div className="grid gap-4 lg:grid-cols-2">
          {process.map((step, index) => (
            <Reveal key={step.title} as="div" delay={100 + index * 80}>
              <div className="rounded-2xl border border-slate-200/70 bg-white/80 p-5 transition hover:-translate-y-1 hover:shadow-lg dark:border-white/10 dark:bg-white/5">
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {testimonials.map((t, index) => (
            <Reveal key={t.name} as="div" delay={120 + index * 90}>
              <div className="rounded-2xl border border-slate-200/70 bg-white/80 p-6 transition hover:-translate-y-1 hover:shadow-lg dark:border-white/10 dark:bg-white/5">
      ...
      <Reveal
        as="section"
        className="rounded-3xl border border-white/10 bg-gradient-to-r from-emerald-700 via-emerald-600 to-emerald-500 p-6 text-white"
      >
