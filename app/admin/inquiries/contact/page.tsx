    ...
    <div className="space-y-6" id="top">
      <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
        <div className="flex flex-wrap items-center justify-between gap-4">
          <div>
            <div className="text-xs uppercase tracking-[0.3em] text-slate-400">İletişim merkezi</div>
            <h1 className="mt-2 text-2xl font-semibold text-slate-900">İletişim mesajları</h1>
            ...
            {items.map((x, index) => {
              ...
              <div className="grid gap-4 border-b border-slate-100 px-6 py-4 text-sm lg:grid-cols-[1.1fr_1fr_1.2fr_1.4fr_0.8fr_0.8fr]">
                <div>
                  ...
                  <div className="text-xs font-semibold uppercase tracking-[0.2em] text-slate-500">İletişim</div>
      ...
      <div className="sticky bottom-4 z-30">
        <div className="flex flex-wrap items-center justify-between gap-3 rounded-2xl border border-slate-200 bg-white/95 px-4 py-3 text-xs text-slate-600 shadow-lg backdrop-blur">
          <div className="flex items-center gap-2">
            <AdminBadge tone="slate">{items.length} mesaj</AdminBadge>
          </div>
